...
class GoToHome():
    ...
    def __init__(self):
        ...
        rospy.init_node('gotohome', anonymous=True)
    ...
    def go_home_callback(self, msg):
        ...
        if (command in self.commands):
            if command == 'gohome':
                ...
                goal1.target_pose.pose = Pose(Point(0.07, -0.03, 0.00), Quaternion(0.000, 0.000, 0.000, 1.000)) # beside the computer
